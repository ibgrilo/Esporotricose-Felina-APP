const sintomas = {
    ulceraNaPele: {
        ...
        dicasECuidados:
            ...
            "🧤 Durante o manuseio, recomenda-se o uso de equipamentos de proteção individual, como luvas e máscaras, para evitar o risco de contaminação.\n\n" +
    ...
    nodulosEAbscessos: {
        ...
        dicasECuidados:
            ...
            "🧤 Utilize equipamentos de proteção individual, como luvas e máscaras, ao lidar com o animal.\n\n" +
    ...
    secrecaoPurulenta: {
        ...
        dicasECuidados:
            ...
            "🧤 Sempre faça o manejo do animal utilizando luvas e máscaras para reduzir o risco de infecção cruzada.\n\n" +
